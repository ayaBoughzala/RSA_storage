 ...
 */
    render() {
        return (
            <div name="download"><h1>DOWNLOAD</h1>
                <div className="content mr-auto ml-auto">

                    {/*will use IPNS here */}
					<input type ="test" id="ipfsURL" onChange={this.search}></input>
                    <img src={`https://ipfs.infura.io/ipfs/${this.state.fileHash}`} className="download" alt="download" />
